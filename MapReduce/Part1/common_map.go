...
func doMap(
	...
	//1. Read input file - parameter inFile
	//2. Call user defined map function - mapF for contents of the file
	//3. Partition mapF's output into nReduce intermediate files - 1 intermediate file/reduce task.
